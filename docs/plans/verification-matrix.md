...
| `web-live`      | RPC + deployed app | User-approved only |                     Wallet-held | Deployed product journey                       |
...
| -------------------------------------------------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------- | --------------- |
| `npm ci`                                                                   | network install              | Reproducible dependencies                                                                   | G0–G6/product   |
...
| `npm run lint`                                                             | offline                      | TS/Solidity/framework lint                                                                  | G5–G6/product   |
| `npm run typecheck`                                                        | offline                      | Strict workspace type safety                                                                | G5–G6/product   |
| `npm run compile`                                                          | offline                      | Contracts and module build graph                                                            | G0–G6/product   |
| `npm run test:automation`                                                  | offline                      | Permissionless policy and runner race/schema tests                                          | G6/product      |
| `npm run test:indexer`                                                     | offline                      | Deterministic public-event reducer and checkpoint tests                                     | G6/product      |
| `npm run rebuild:indexer:sepolia`                                          | sepolia-read                 | Manifest-bound finalized public-event replay and checkpoint evidence                        | G6/product      |
...
| `npm run test:unit`                                                        | offline                      | Domain, SDK, reducer, component units                                                       | G5–G6/product   |
...
| `npm run test:e2e:sepolia`                                                 | sepolia-write                | Full lifecycle across deployed modules                                                      | G5–G6/product   |
| `npm run test:web`                                                         | offline                      | Component, accessibility, and deterministic UI-state tests                                  | product         |
| `npm run test:sepolia:read`                                                | sepolia-read                 | Manifest, bytecode, events, public verifier                                                 | G6/product      |
...
| `npm run check:offline`                                                    | offline                      | Complete no-chain merge gate                                                                | G0–G6/product   |
| `npm run check:sepolia:read`                                               | sepolia-read                 | Complete no-write chain/evidence gate                                                       | G0/G6/product   |
