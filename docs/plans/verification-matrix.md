...
| `npm run verify:g7:web -- --evidence=<path> [--out=<path>]`                | sepolia-read                 | Public-only browser evidence, immutable release, receipt recipient/selector, and recovery-selector verification | G7/G8           |
