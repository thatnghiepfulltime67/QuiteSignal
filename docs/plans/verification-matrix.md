...
| -------------------------------------------------------------------------- | ---------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------- |
| `npm ci`                                                                   | network install              | Reproducible dependencies                                                                                       | G0–G7           |
...
| `npm run lint`                                                             | offline                      | TS/Solidity/framework lint                                                                                      | G5–G7           |
| `npm run typecheck`                                                        | offline                      | Strict workspace type safety                                                                                    | G5–G7           |
| `npm run compile`                                                          | offline                      | Contracts and module build graph                                                                                | G0–G7           |
| `npm run test:automation`                                                  | offline                      | Permissionless policy and runner race/schema tests                                                              | G6–G7           |
| `npm run test:indexer`                                                     | offline                      | Deterministic public-event reducer and checkpoint tests                                                         | G6–G7           |
| `npm run rebuild:indexer:sepolia`                                          | sepolia-read                 | Manifest-bound finalized public-event replay and checkpoint evidence                                            | G6–G7           |
...
| `npm run verify:automation:sepolia`                                        | sepolia-read                 | Fixed receipt/selector and aggregate-finalization verification for AUT-01                                       | G6              |
| `npm run test:unit`                                                        | offline                      | Domain, SDK, reducer, component units                                                                           | G5–G7           |
| `npm run test:model`                                                       | offline                      | Pure state/math/reference-model property and fuzz tests                                                         | G1/G5           |
| `npm run test:contracts:sepolia -- <case>`                                 | sepolia-write                | Named contract state/economic case                                                                              | G1–G6           |
| `npm run test:nox:sepolia -- <case>`                                       | sepolia-write                | Named ACL/compute/proof/asset case                                                                              | G1–G3/G5        |
...
| `npm run test:adversarial:sepolia -- <case>`                               | sepolia-write                | Replay, unauthorized, timeout, stale feed, reentrancy case                                                      | G5              |
| `npm run test:e2e:sepolia`                                                 | sepolia-write                | Full lifecycle across deployed modules                                                                          | G5–G7           |
| `npm run test:web`                                                         | offline                      | Component, accessibility, and deterministic UI-state tests                                                      | G7              |
| `npm run test:sepolia:read`                                                | sepolia-read                 | Manifest, bytecode, events, public verifier                                                                     | G6–G7           |
...
| `npm run verify:protocol:sepolia -- --manifest=<path>`                     | sepolia-read                 | Runtime hashes, immutable bindings, historical/current public epoch, and receipts                               | G6              |
...
| `npm run verify:g7:web -- --evidence=<path> [--out=<path>]`                | sepolia-read                 | Public-only browser evidence, immutable release, receipt recipient/selector, and recovery-selector verification | G7              |
| `npm run scan:secrets`                                                     | offline                      | Repository/history/generated evidence scan                                                                      | every commit    |
| `npm run scan:dependencies`                                                | network/read                 | Advisories and licenses                                                                                         | G0              |
| `npm run check:offline`                                                    | offline                      | Complete no-chain merge gate                                                                                    | G0–G7           |
| `npm run check:sepolia:read`                                               | sepolia-read                 | Complete no-write chain/evidence gate                                                                           | G0/G6–G7        |
...
- At least 1,000 offline reference-model fuzz/property cases per invariant in PR
  checks; contract conclusions require named Sepolia vectors.
...
| Sepolia read     | PR/submission verification  | read verifier, manifest, evidence                       | None                   |
