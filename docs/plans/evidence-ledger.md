...
| G7   | `user_confirmed` | web-live / operator attestation         | `evidence/sepolia/G7/WEB-08-USER-ATTESTATION.md`                                                                                                                                                                                                                                                                                                  | Current web source; deployment has no Git attribution                       | Sepolia / production deployment `dpl_A7wBNzYPWuqHGx4dqUyGorXwSNtm` | Production frontend `https://quitesignal.vercel.app`                                                                                                                                                                                                                                                                            | User-confirmed complete production browser matrix with real Sepolia wallets: primary, recovery/refund, wrong-owner, reconnect/degraded-service, accessibility, responsive, and route paths                                                                                  | This is a sanitized operator attestation, not an independently replayable verifier report; Plan policy therefore retains `user_confirmed`.                    |
| G8   | `failed`         | Node 24.18 / Sepolia read               | `evidence/reports/G8-readiness-2026-08-02.md`                                                                                                                                                                                                                                                                                                     | `5896376` and this readiness update                                         | `11155111` / verifier block `11397936`                             | Canonical deployment and Ready production frontend; no new chain write                                                                                                                                                                                                                                                          | Clean-clone install/offline/web/interfaces/build, archive deployment verification, zero-vulnerability dependency scan, evidence verification, secret scan, and full operator browser attestation recorded                                                                   | Archive RPC, R-16, clean reproduction, and operator test scope are resolved. Independent G7 evidence and final-checkpoint deployment attribution remain open. |
