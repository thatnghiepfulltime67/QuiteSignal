...
| G8   | `failed`  | Node 24.18 / Sepolia read       | `evidence/reports/G8-readiness-2026-08-02.md`                                                                                                                                                                                                                                                                                                     | `361a2eb`                                                                   | `11155111`                       | Canonical manifest verifier attempted; no new write                                                                                                                                                                                                                                                                                 | Clean archive compile/build, offline checks, web tests, interfaces, doctor/budget, G3 evidence verifier, and secret scan passed                                                                                                                                                                                                        | Blocked by archive-capable RPC, unresolved R-16 high advisory, incomplete independent G7 scope, and dirty worktree. Do not claim release readiness. |
