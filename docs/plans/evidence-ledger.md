...
| G8   | `failed`         | Node 24.18 / Sepolia read               | `evidence/reports/G8-readiness-2026-08-02.md`                                                                                                                                                                                                                                                                                                     | `a25a6c5` and this readiness update                                         | `11155111` / verifier block `11397936`                             | Canonical deployment and Ready production frontend; no new chain write                                                                                                                                                                                                                                                          | Archive deployment verification, zero-vulnerability dependency scan, compile, web/interfaces/verifier/SDK/automation/indexer tests, build, evidence verification, and secret scan passed                                                                                    | Archive RPC and R-16 are resolved. Final clean reproduction/deployment and the unattested browser-recovery scope remain open.                 |
