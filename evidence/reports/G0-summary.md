...
The current Hardhat dependency graph has two high-severity npm advisory findings
and no critical finding. R-16 records the mitigation and requires re-evaluation
before G8. This result does not prove confidential computation, ACL, asset, proof,
